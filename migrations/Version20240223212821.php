 ...
 */
final class Version20240223212821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE release_manga_updates_api (id INT AUTO_INCREMENT NOT NULL, manga_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', released_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', volume_val VARCHAR(50) DEFAULT NULL, chapter_val VARCHAR(50) NOT NULL, INDEX IDX_C9D845747B6461 (manga_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
